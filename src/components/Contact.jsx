...
// public key -- 3kvtsH07BHQuOL3od
// service key -- service_hcvt4xm
// template key -- 3kvtsH07BHQuOL3od
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await emailjs.sendForm(
        "service_hcvt4xm", // service key
        "template_h6z1gfh", // template key
        formRef.current,
        "3kvtsH07BHQuOL3od", ///public key
      );
      setStatus("success");
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a
                    ...
                    className="text-sm text-[#0025cc] hover:underline"
                  >
