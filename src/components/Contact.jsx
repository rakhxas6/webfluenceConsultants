...
export default function Contact() {
  return (
    <section className="py-16 px-4 border-t border-neutral-300 scroll-mt-[8vh]" id="contact">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-2/5 space-y-8">
            <div>
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                We help businesses grow their digital presence through smart strategy,
                stunning design, and powerful technology. From startups to enterprises,
                we deliver solutions that drive clicks, conversions, and growth.
              </p>
            </div>
            ...
            <div className="space-y-5">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="tel:+11234567890" className="text-sm text-[#0025cc] hover:underline">+977 986 792 5779</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#0025cc]">Mon – Fri: 9am – 6pm<br/>Sat: 10am – 2pm</p>
                </div>
              </div>
            </div>
          ...
          {/* Right — Form */}
          <form className="lg:w-3/5 flex flex-col gap-6 text-sm">
            ...
            <button
              type="submit"
              className="self-start bg-[#0025cc] text-white h-12 px-10 rounded active:scale-95 transition hover:bg-[#0025cc]/90"
            >
              Send Message
            </button>
          </form>
